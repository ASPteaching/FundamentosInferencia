...
# quarto::quarto_render("EstadMat-AllChap(ES).qmd", output_format = "all")
```
...
## Del lenguaje natural a la hipótesis paramétrica
...
### Cas 1: Hipótesis para dirimir la controversia sobre el número de hembras
...
### Cas 2: Hipótesis a contrastar en el problema de la tasa de statdrolona
...
### Cas 1: Compatibilidad de resultados e hipótesis
...
### Cas 2: Compatibilidad de resultados e hipótesis
...
### Cas 1: Una región con n.º de hembras con baja probabilidad bajo $\mathrm{H}_{0}$
...
### Cas 2: Medias de las tasas de statdrolona improbables si se cumple $\mathrm{H}_{0}$
...
### Cas 1: N.º de nidos propuestos ad hoc como inicio de región crítica. Regla de decisión resultante
...
### Cas 1: Elección de la región crítica
...
### Cas 2: Elección de la región crítica
...
### Cas 1: Resumen de conceptos asociados al contraste. Región crítica
...
### Cas 2: Tabla resumen de la región crítica, el estadístico de test y del criterio de decisión
...
### Cas 1: Evaluación de los dos errores asociados al contraste
...
### Cas 2: Cálculo explícito de los errores de primera ( $\alpha$ ) y segunda especie (1- $\beta$ )
...
### Cas 1: Evaluación de $\alpha$ y 1- $\beta$ para diferentes regiones críticas
...
### Cas 2: Relación entre los errores de primera ( $\alpha$ ) y segunda especie (1- $\beta$ )
...
### Cas 1: Potencia en hipótesis simple vs simple
...
### Cas 2: Potencia en hipótesis simple vs simple
...
### Cas 1: Cálculo del p-valor (prueba unilateral)
...
### Cas 2: Cálculo del p-valor (prueba unilateral)
...
### Cas 2: Cálculo del p-valor (prueba bilateral)
...
### Cas 2: Relación con los intervalos de confianza
...
### Cas 2: Cálculo del tamaño de la muestra
...
### Cas 2: Significación estadística y aplicada
