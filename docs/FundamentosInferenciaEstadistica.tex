...
\section{\texorpdfstring{Pruebas \(\mathrm{X}^{2}\)}{Pruebas \textbackslash mathrm\{X\}\^{}\{2\}}}\label{pruebas-mathrmx2}
...
\subsection{El modelo multinomial.}\label{el-modelo-multinomial.}
...
\subsubsection{Aplicaciones del modelo multinomial.}\label{aplicaciones-del-modelo-multinomial.}
...
\subsubsection{Formalización del contraste.}\label{formalizaciuxf3n-del-contraste.}
...
\subsubsection{Condiciones de validez.}\label{condiciones-de-validez.}
...
\subsection{Análisis de Tablas de contingencia.}\label{anuxe1lisis-de-tablas-de-contingencia.}
...
Característica B
\textbar{} Característica A \textbar{} \textbar{} \(\mathrm{B}_{1}\) \textbar{} \(\mathrm{B}_{2}\) \textbar{} \(\dots\) \textbar{} \(\mathrm{B}_{m}\) \textbar{} Total \textbar{}
\textbar{} :--- \textbar{} :--- \textbar{} :--- \textbar{} :--- \textbar{} :--- \textbar{} :--- \textbar{} :--- \textbar{}
\textbar{} \textbar{} \(\mathrm{A}_{1}\) \textbar{} \(n_{11}\) \textbar{} \(n_{12}\) \textbar{} \(\dots\) \textbar{} \(n_{1 m}\) \textbar{} \(n_{1}\). \textbar{}
\textbar{} \textbar{} \(\mathrm{A}_{2}\) \textbar{} \(n_{21}\) \textbar{} \(n_{22}\) \textbar{} \(\dots\) \textbar{} \(n_{2 m}\) \textbar{} \(n_{2}\). \textbar{}
\textbar{} \textbar{} \(\dots\) \textbar{} \(\dots\) \textbar{} \(\dots\) \textbar{} \(\dots\) \textbar{} \(\dots\) \textbar{} \(\dots\) \textbar{}
\textbar{} \textbar{} \(\mathrm{A}_{k}\) \textbar{} \(n_{k 1}\) \textbar{} \(n_{k 2}\) \textbar{} \(\dots\) \textbar{} \(n_{k m}\) \textbar{} \(n_{k}\). \textbar{}
\textbar{} \textbar{} Total \textbar{} \(n \cdot 1\) \textbar{} \(n \cdot 2\) \textbar{} \(\dots\) \textbar{} \(n_{\cdot m}\) \textbar{} \(N\) \textbar{}
...
\subsubsection{Pruebas de independencia.}\label{pruebas-de-independencia.}
...
\subsubsection{Violación de las condiciones del contraste.}\label{violaciuxf3n-de-las-condiciones-del-contraste.}
...
\subsection{La distribución Multinomial}\label{la-distribuciuxf3n-multinomial-1}
...
\subsection{La distribución Binomial}\label{la-distribuciuxf3n-binomial-1}
