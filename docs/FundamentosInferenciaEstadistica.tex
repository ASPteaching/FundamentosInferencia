...
\footnote{La statdrolona no es ninguna hormona, aquí se ha adaptado la información de hormonas reales.}Calculemos la varianza
...
\begin{center}\includegraphics[width=0.9\linewidth]{images/cap9-ProbsH0} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{images/cap9-ProbsH1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{images/cap9-ProbsErrTipo2} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{images/cap9-ProbsErrTipo2c} \end{center}
