...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.3191}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x0}\OtherTok{\textless{}{-}}\FunctionTok{c}\NormalTok{(}\FloatTok{5.1}\NormalTok{, }\FloatTok{3.4}\NormalTok{, }\FloatTok{1.2}\NormalTok{, }\FloatTok{17.6}\NormalTok{, }\FloatTok{2.1}\NormalTok{, }\FloatTok{16.4}\NormalTok{, }\FloatTok{4.3}\NormalTok{)}
\NormalTok{Fn }\OtherTok{\textless{}{-}} \FunctionTok{ecdf}\NormalTok{(x0)}
\FunctionTok{plot}\NormalTok{(Fn)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{FundamentosInferenciaEstadistica_files/figure-latex/unnamed-chunk-88-1.pdf}}
